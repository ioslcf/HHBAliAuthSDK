...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of HHBAliAuthSDK.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/liuchengfei/HHBAliAuthSDK'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'liuchengfei' => '13717883106@163.com' }
  s.source           = { :git => 'https://github.com/liuchengfei/HHBAliAuthSDK.git', :tag => s.version.to_s }
